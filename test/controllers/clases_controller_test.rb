...
class ClasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clase" do
    assert_difference('Clase.count') do
      post clases_url, params: { clase: { clave: @clase.clave, horario: @clase.horario, indice: @clase.indice, materium_id: @clase.materium_id, profesor_id: @clase.profesor_id } }
    end
  ...
  test "should update clase" do
    patch clase_url(@clase), params: { clase: { clave: @clase.clave, horario: @clase.horario, indice: @clase.indice, materium_id: @clase.materium_id, profesor_id: @clase.profesor_id } }
