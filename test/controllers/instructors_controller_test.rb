...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { ap_mat: @instructor.ap_mat, ap_pat: @instructor.ap_pat, nombre: @instructor.nombre } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { ap_mat: @instructor.ap_mat, ap_pat: @instructor.ap_pat, nombre: @instructor.nombre } }
