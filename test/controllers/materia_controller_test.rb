...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post materia_url, params: { materium: { Horas: @materium.Horas, creditos: @materium.creditos, matricula: @materium.matricula, nombre: @materium.nombre, semestre: @materium.semestre } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { Horas: @materium.Horas, creditos: @materium.creditos, matricula: @materium.matricula, nombre: @materium.nombre, semestre: @materium.semestre } }
